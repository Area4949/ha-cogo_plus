...
3) Create an 'in zone' template sensor that calls the primary zone testing function. In the following example, the sensor will have either a true or false state.
